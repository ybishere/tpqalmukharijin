...
<?php $__env->startSection('title', 'Infaq Kamisan – TPQ Al-Mukharijin'); ?>
    ...
    <div class="max-w-6xl mx-auto px-6">
        <div class="max-w-3xl mx-auto fade-up">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                ...
                ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dampak): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="text-center p-5 rounded-2xl bg-white border border-stone-100 shadow-sm">
                    <div class="text-3xl mb-3"><?php echo e($dampak['icon']); ?></div>
                    <h4 class="font-bold text-stone-800 text-sm mb-2"><?php echo e($dampak['judul']); ?></h4>
                    <p class="text-stone-500 text-xs leading-relaxed"><?php echo e($dampak['desc']); ?></p>
                </div>
    ...
    <div class="max-w-6xl mx-auto px-6">
        <div class="max-w-md mx-auto fade-up text-center">
            ...
            <div class="bg-white rounded-3xl p-8 shadow-sm border border-amber-100">
                ...
                <div class="space-y-2">
                    ...
                    <div class="flex items-center gap-3 text-left">
                        <span class="w-5 h-5 rounded-full bg-amber-500 text-white text-[10px] font-bold flex items-center justify-center shrink-0"><?php echo e($i+1); ?></span>
                        <p class="text-xs text-stone-500"><?php echo e($step); ?></p>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
            ...
            <div class="mt-6">
                ...
                <a href="https://wa.me/<?php echo e(preg_replace('/[^0-9]/', '', $profil->no_telp)); ?>?text=Assalamualaikum, saya ingin konfirmasi infaq kamisan TPQ Al-Mukharijin"
                    target="_blank"
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\tpq-almukharijin\resources\views/infaq/index.blade.php ENDPATH**/ ?>