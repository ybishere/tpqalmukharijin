...
<?php $__env->startSection('page_title', 'Manajemen Kegiatan'); ?>
...
<div class="flex items-center justify-between mb-6">
    <div>
        ...
        <p class="text-xs text-stone-400 mt-0.5"><?php echo e($activities->total()); ?> total kegiatan</p>
    </div>
...
<div class="bg-white rounded-2xl border border-stone-100 shadow-sm overflow-hidden">
            ...
            <tr class="hover:bg-stone-50/50 transition-colors">
                <td class="px-5 py-3.5">
                    <div class="flex items-center gap-3">
                        ...
                        <img src="<?php echo e(Storage::url($item->thumbnail)); ?>"
                        ...
                        <?php endif; ?>
                        <div class="min-w-0">
                            <p class="font-semibold text-stone-800 text-xs truncate max-w-[240px]"><?php echo e($item->judul); ?></p>
                            <p class="text-stone-400 text-[11px] mt-0.5"><?php echo e(Str::limit($item->deskripsi, 55)); ?></p>
                        </div>
                    </div>
                </td>
                ...
                <td class="py-3.5 text-center">
                    <span class="text-xs font-semibold text-stone-500"><?php echo e($item->photos_count); ?> foto</span>
                </td>
                <td class="py-3.5 text-center">
                    <?php
                    ...
                    ?>
                    <span class="inline-flex text-[11px] font-semibold px-2.5 py-1 rounded-full <?php echo e($badge['class']); ?>">
                ...
                <td class="px-5 py-3.5">
                    <div class="flex items-center justify-end gap-2">
                        <a href="<?php echo e(route('admin.kegiatan.edit', $item)); ?>"
                        ...
                        <form method="POST" action="<?php echo e(route('admin.kegiatan.destroy', $item)); ?>"
    ...
    <div class="px-5 py-4 border-t border-stone-100"><?php echo e($activities->links()); ?></div>
    <?php endif; ?>
</div>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\tpq-almukharijin\resources\views/admin/kegiatan/index.blade.php ENDPATH**/ ?>