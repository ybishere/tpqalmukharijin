...
<?php $__env->startSection('title', 'Alumni – TPQ Al-Mukharijin'); ?>
        ...
        <div class="grid lg:grid-cols-2 gap-12 items-center">
            <div>
                ...
                <div class="flex gap-8">
                    <div>
                        <p class="text-3xl font-extrabold text-white"><?php echo e($totalAlumni); ?>+</p>
                        <p class="text-white/40 text-xs mt-1">Total Alumni</p>
                    </div>
                    <div class="w-px bg-white/10"></div>
                    <div>
                        <p class="text-3xl font-extrabold text-amber-300"><?php echo e($totalAngkatan); ?></p>
                        <p class="text-white/40 text-xs mt-1">Angkatan</p>
                    </div>
                    <div class="w-px bg-white/10"></div>
                    <div>
                        <p class="text-3xl font-extrabold text-emerald-300"><?php echo e($angkatanPertama); ?></p>
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-5 mb-10">
            ...
            <div class="flex flex-col sm:flex-row gap-3">
                ...
                <select x-model="angkatan"
                    ...
                    <?php $__currentLoopData = $angkatanList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $thn): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($thn); ?>">Angkatan <?php echo e($thn); ?></option>
    ...
    <div class="max-w-6xl mx-auto px-6">
        <div class="rounded-3xl p-10 relative overflow-hidden"
            ...
            <div class="relative flex flex-col md:flex-row items-center justify-between gap-6">
                ...
                <a href="<?php echo e(route('profil.index')); ?>#lokasi"
...
function alumniData() {
    return {
        search: '',
        angkatan: 'semua',
        rows: <?php echo json_encode($alumni->map(fn($a) => [
            'nama' => $a->nama, 'tahun' => (int) $a->tahun_angkatan, 'keterangan' => $a->keterangan ?? ''
        ])) ?>,
        get filtered() {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\tpq-almukharijin\resources\views/alumni/index.blade.php ENDPATH**/ ?>