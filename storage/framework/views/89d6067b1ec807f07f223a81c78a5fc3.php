...
<div class="grid grid-cols-2 xl:grid-cols-4 gap-4 mb-6">
    ...
    <div class="bg-white rounded-2xl p-5 border border-stone-100 shadow-sm">
        ...
        <p class="text-2xl font-extrabold text-stone-800"><?php echo e(\App\Models\Student::where('is_active', true)->count()); ?></p>
    ...
    <div class="bg-white rounded-2xl p-5 border border-stone-100 shadow-sm">
        ...
        <p class="text-2xl font-extrabold text-stone-800"><?php echo e(\App\Models\Alumni::count()); ?></p>
    ...
    <div class="bg-white rounded-2xl p-5 border border-stone-100 shadow-sm">
        ...
        <p class="text-2xl font-extrabold text-stone-800"><?php echo e(\App\Models\Donasi::where('status_bayar','sukses')->count()); ?></p>
    ...
    <div class="bg-white rounded-2xl p-5 border border-stone-100 shadow-sm">
        ...
        <p class="text-2xl font-extrabold text-stone-800">
            Rp <?php echo e(number_format(\App\Models\Donasi::where('status_bayar','sukses')->sum('jumlah'), 0, ',', '.')); ?>
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-6">
    ...
    <div class="lg:col-span-2 rounded-2xl p-6 relative overflow-hidden"
        ...
        <div class="relative">
            ...
            <p class="text-white font-extrabold text-2xl mb-4">Rp <?php echo e(number_format($totalDana, 0, ',', '.')); ?>
            ...
            <div class="h-1.5 rounded-full mb-2" style="background:rgba(255,255,255,0.1)">
                <div class="h-full rounded-full" style="width:<?php echo e($persen); ?>%;background:linear-gradient(90deg,#10b981,#fbbf24);transition:width 1s ease;"></div>
            </div>
            <div class="flex items-center justify-between text-xs text-white/50 mb-4">
                <span><?php echo e($persen); ?>% dari target</span>
                <span>Target: Rp <?php echo e(number_format($totalTarget, 0, ',', '.')); ?></span>
            </div>
            <div class="grid grid-cols-2 gap-3">
                <div class="rounded-xl px-4 py-3" style="background:rgba(255,255,255,0.07)">
                    ...
                    <p class="text-white font-bold text-sm">Rp <?php echo e(number_format($totalKeluar, 0, ',', '.')); ?></p>
                </div>
                <div class="rounded-xl px-4 py-3" style="background:rgba(16,185,129,0.15)">
                    ...
                    <p class="text-emerald-300 font-bold text-sm">Rp <?php echo e(number_format($saldo, 0, ',', '.')); ?></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="flex flex-col gap-4">
        <div class="bg-white rounded-2xl p-4 border border-stone-100 shadow-sm flex items-center gap-4">
            ...
            <div>
                <p class="text-xl font-extrabold text-stone-800"><?php echo e(\App\Models\Program::where('status','aktif')->count()); ?></p>
        ...
        <div class="bg-white rounded-2xl p-4 border border-stone-100 shadow-sm flex items-center gap-4">
            ...
            <div>
                <p class="text-xl font-extrabold text-stone-800"><?php echo e(\App\Models\Activity::where('status','akan_datang')->count()); ?></p>
        ...
        <div class="bg-white rounded-2xl p-4 border border-stone-100 shadow-sm flex items-center gap-4">
            ...
            <div>
                <p class="text-xl font-extrabold text-stone-800"><?php echo e(\App\Models\Announcement::where('is_active', true)->count()); ?></p>
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-stone-50">
                    <?php $__empty_1 = true; $__currentLoopData = \App\Models\Donasi::with('program')->where('status_bayar','sukses')->latest()->take(10)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-stone-50/50 transition-colors">
                        <td class="px-5 py-3 font-medium text-stone-800 text-xs"><?php echo e($d->nama_donatur ?? 'Anonim'); ?></td>
                        <td class="py-3 text-stone-400 text-xs truncate max-w-[140px]"><?php echo e($d->program->nama_program ?? '-'); ?></td>
                        <td class="py-3 text-right text-emerald-600 font-bold text-xs">Rp <?php echo e(number_format($d->jumlah, 0, ',', '.')); ?></td>
                        <td class="px-5 py-3 text-right text-stone-300 text-xs"><?php echo e($d->created_at->format('d/m/Y')); ?></td>
                    </tr>
    ...
    <div class="bg-white rounded-2xl border border-stone-100 shadow-sm overflow-hidden">
        ...
        <div class="p-5 space-y-4">
            <?php $__empty_1 = true; $__currentLoopData = \App\Models\Program::where('status','aktif')->take(5)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <?php $pct = $p->target_dana > 0 ? min(100, round(($p->dana_terkumpul / $p->target_dana) * 100)) : 0; ?>
            <div>
                <div class="flex items-center justify-between mb-1.5">
                    <p class="text-xs font-semibold text-stone-700 truncate flex-1 mr-2"><?php echo e($p->nama_program); ?></p>
                    <span class="text-[11px] font-bold <?php echo e($pct >= 75 ? 'text-emerald-600' : ($pct >= 40 ? 'text-amber-600' : 'text-stone-400')); ?> flex-shrink-0">
                        <?php echo e($pct); ?>%
                    </span>
                </div>
                <div class="h-1.5 bg-stone-100 rounded-full overflow-hidden">
                    <div class="h-full rounded-full transition-all duration-700"
                        style="width:<?php echo e($pct); ?>%;background:<?php echo e($pct >= 75 ? 'linear-gradient(90deg,#10b981,#059669)' : ($pct >= 40 ? 'linear-gradient(90deg,#f59e0b,#d97706)' : '#e5e7eb')); ?>">
                    </div>
                </div>
                <p class="text-[10px] text-stone-300 mt-1">
                    Rp <?php echo e(number_format($p->dana_terkumpul, 0, ',', '.')); ?> / Rp <?php echo e(number_format($p->target_dana, 0, ',', '.')); ?>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\tpq-almukharijin\resources\views/admin/dashboard/index.blade.php ENDPATH**/ ?>