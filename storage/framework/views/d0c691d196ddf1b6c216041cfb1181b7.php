...
<?php $__env->startSection('title', 'Beranda – TPQ Al-Mukharijin'); ?>

<?php $__env->startSection('meta_description', 'TPQ Al-Mukharijin Desa Kreman, Kec. Warureja, Kab. Tegal. Lembaga pendidikan Al-Quran yang mendidik generasi Qurani sejak 1991.'); ?>
<?php $__env->startSection('og_title', 'TPQ Al-Mukharijin – Tempat Belajar Al-Quran Desa Kreman'); ?>
<?php $__env->startSection('og_description', 'Mendidik generasi Qurani yang berakhlak mulia, cerdas, dan bermanfaat bagi agama dan masyarakat.'); ?>
            ...
            <div>
                ...
                <div class="hero-animate space-y-4 mb-10">
                    ...
                    <div class="flex flex-wrap gap-2 pt-1">
                        <?php $__currentLoopData = ['Tartil & Tajwid','Akhlakul Karimah','Hafalan Juz Amma','Pendidikan Agama']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <span style="background:rgba(16,185,129,0.1);border:1px solid rgba(16,185,129,0.2);color:#6ee7b7;font-size:11px;font-weight:600;padding:4px 12px;border-radius:100px;"><?php echo e($tag); ?></span>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </div>
                <div class="hero-animate flex flex-wrap gap-3">
                    <a href="<?php echo e(route('profil.index')); ?>" class="btn-primary">
                    ...
                    <a href="<?php echo e(route('kegiatan.index')); ?>" class="btn-ghost">
...
<div class="hero-animate relative hidden lg:block"
    ...
    <div class="relative overflow-hidden rounded-3xl"
        ...
        <div class="flex h-full transition-transform duration-700 ease-in-out"
            ...
            <?php $__currentLoopData = $kegiatanSlider; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slide): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="h-full relative flex-shrink-0" style="width:<?php echo e(100 / $kegiatanSlider->count()); ?>%">
                <img src="<?php echo e(Storage::url($slide->thumbnail)); ?>"
                    alt="<?php echo e($slide->judul); ?>"
...
<section class="relative h-[500px] md:h-[580px] overflow-hidden">
    ...
    <img src="<?php echo e(asset('images/gedung-tpq.jpg')); ?>"
...
<section class="py-24 bg-[#fafaf9]">
    <div class="max-w-6xl mx-auto px-6">
        <div class="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-14">
            ...
            <a href="<?php echo e(route('kegiatan.index')); ?>" class="self-start inline-flex items-center gap-2 text-sm font-semibold text-emerald-700 hover:text-emerald-900 transition-colors group">
                Lihat semua
                <svg class="w-4 h-4 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
            </a>
        </div>

        <?php if(isset($kegiatan) && $kegiatan->count()): ?>
        <?php $featured = $kegiatan->first(); $rest = $kegiatan->skip(1); ?>
        <div class="grid lg:grid-cols-5 gap-6">

            
            <a href="<?php echo e(route('kegiatan.show', $featured->id)); ?>"
                class="lg:col-span-3 fade-up card group block relative overflow-hidden" style="min-height:400px;">
                <?php if($featured->thumbnail): ?>
                    <img src="<?php echo e(Storage::url($featured->thumbnail)); ?>" alt="<?php echo e($featured->judul); ?>"
                ...
                <div class="absolute bottom-0 left-0 right-0 p-7">
                    <span class="badge <?php echo e($featured->status==='akan_datang'?'badge-amber':'badge-green'); ?> mb-3">
                        <?php echo e($featured->status==='akan_datang'?'⏰ Akan Datang':'✓ Selesai'); ?>

                    </span>
                    <h3 class="text-white font-extrabold text-xl leading-tight mb-2"><?php echo e($featured->judul); ?></h3>
                    <div class="flex items-center gap-4 text-white/55 text-sm">
                        <span class="flex items-center gap-1.5">
                            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
                            <?php echo e(\Carbon\Carbon::parse($featured->tanggal)->translatedFormat('d F Y')); ?>

                        </span>
                    </div>
                    <?php if($featured->deskripsi): ?>
                    <p class="text-white/45 text-sm mt-2 line-clamp-2"><?php echo e(Str::limit($featured->deskripsi, 100)); ?></p>
                    <?php endif; ?>
                </div>
            </a>
            ...
            <div class="lg:col-span-2 flex flex-col gap-5">
                <?php $__currentLoopData = $rest; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route('kegiatan.show', $item->id)); ?>" class="fade-up card group flex gap-4 p-5 items-start">
                    <?php if($item->thumbnail): ?>
                        <img src="<?php echo e(Storage::url($item->thumbnail)); ?>" alt="<?php echo e($item->judul); ?>" class="w-20 h-20 rounded-xl object-cover shrink-0">
                    <?php else: ?>
                    ...
                    <div class="flex-1 min-w-0">
                        <span class="badge <?php echo e($item->status==='akan_datang'?'badge-amber':'badge-green'); ?> mb-2">
                            <?php echo e($item->status==='akan_datang'?'Akan Datang':'Selesai'); ?>

                        </span>
                        <h3 class="font-bold text-stone-900 text-sm leading-snug line-clamp-2 group-hover:text-emerald-800 transition-colors"><?php echo e($item->judul); ?></h3>
                        <p class="text-stone-400 text-xs mt-1.5"><?php echo e(\Carbon\Carbon::parse($item->tanggal)->translatedFormat('d M Y')); ?></p>
                        <?php if($item->deskripsi): ?>
                        <p class="text-stone-400 text-xs mt-1 line-clamp-1"><?php echo e(Str::limit($item->deskripsi, 60)); ?></p>
                        <?php endif; ?>
                    </div>
                </a>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="grid lg:grid-cols-5 gap-12">
            ...
            <div class="lg:col-span-3">
                ...
                <div class="flex items-end justify-between mb-8">
                    ...
                    <a href="<?php echo e(route('pengumuman.index')); ?>" class="inline-flex items-center gap-1.5 text-sm font-semibold text-emerald-700 hover:text-emerald-900 transition-colors group">
                        Semua
                        <svg class="w-4 h-4 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
                    </a>
                </div>
                ...
                <div class="space-y-3">
                    <?php if(isset($pengumuman) && $pengumuman->count()): ?>
                        <?php $__currentLoopData = $pengumuman; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e(route('pengumuman.show', $item->id)); ?>" class="announcement-row fade-up">
                            ...
                            <div class="flex-1 min-w-0">
                                <p class="text-xs text-stone-400 mb-0.5"><?php echo e(\Carbon\Carbon::parse($item->tanggal_publish)->translatedFormat('d F Y')); ?></p>
                                <h3 class="font-bold text-stone-900 text-sm leading-snug line-clamp-1"><?php echo e($item->judul); ?></h3>
                                <p class="text-stone-500 text-xs mt-0.5 line-clamp-1"><?php echo e(Str::limit(strip_tags($item->isi), 80)); ?></p>
                            </div>
                    ...
                    <div class="p-4">
                        ...
                        <div class="mt-3 pt-3 border-t border-stone-100">
                            ...
                            <div style="background:#f0fdf4;border:1px solid #bbf7d0;border-radius:12px;padding:10px 12px;">
                                <p class="text-emerald-800 font-bold text-xs leading-tight"><?php echo e($kegiatanTerdekat->judul); ?></p>
                                <p class="text-emerald-600 text-[10px] mt-1"><?php echo e(\Carbon\Carbon::parse($kegiatanTerdekat->tanggal)->translatedFormat('d F Y')); ?></p>
                            </div>
                        </div>
                        <?php endif; ?>
                    </div>
...
<section class="py-24 bg-white">
    <div class="max-w-6xl mx-auto px-6">
        ...
        <div class="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-14">
            ...
            <a href="<?php echo e(route('donasi.landing')); ?>"
            ...
            <div class="relative grid md:grid-cols-3 gap-8">
                <div class="text-center md:text-left">
                    ...
                    <p class="text-white font-extrabold" style="font-size:clamp(1.6rem,3vw,2.5rem);">
                        Rp <?php echo e(number_format($totalDonasi ?? 0, 0, ',', '.')); ?>
                ...
                <div class="text-center">
                    ...
                    <p class="text-amber-300 font-extrabold" style="font-size:clamp(1.6rem,3vw,2.5rem);">
                        Rp <?php echo e(number_format($totalTarget ?? 0, 0, ',', '.')); ?>

                    </p>
                </div>
                <div class="text-center md:text-right flex flex-col justify-center">
                    <?php $persen = ($totalTarget ?? 0) > 0 ? min(100, round(($totalDonasi / $totalTarget) * 100)) : 0; ?>
                    <p class="text-white/50 text-xs uppercase tracking-widest font-semibold mb-2">Tercapai</p>
                    <p class="text-emerald-300 font-extrabold text-4xl"><?php echo e($persen); ?>%</p>
                </div>
            </div>
            
            <div class="relative mt-6">
                <div class="h-2 rounded-full" style="background:rgba(255,255,255,0.1);">
                    <div class="h-full rounded-full progress-fill" data-width="<?php echo e($persen); ?>"
                        style="width:0%;background:linear-gradient(90deg,#10b981,#fbbf24);transition:width 1.2s cubic-bezier(0.34,1.56,0.64,1);">
                    </div>
                </div>
                <p class="text-white/30 text-xs mt-2"><?php echo e($persen); ?>% dari total target keseluruhan program</p>
            </div>
        </div>
            ...
            <div class="fade-up card p-6">
                <div class="flex items-start justify-between gap-4 mb-4">
                    <div class="flex-1 min-w-0">
                        ...
                        <h3 class="font-bold text-stone-900 text-base leading-snug"><?php echo e($prog->nama_program); ?></h3>
                        <?php if($prog->deskripsi): ?>
                        <p class="text-stone-500 text-xs mt-1 line-clamp-2"><?php echo e(Str::limit($prog->deskripsi, 80)); ?></p>
                        <?php endif; ?>
                    </div>
                    <div class="text-right shrink-0">
                        <p class="font-extrabold text-emerald-700 text-lg leading-none"><?php echo e($p); ?>%</p>
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="font-bold text-stone-800 text-sm">Rp <?php echo e(number_format($prog->dana_terkumpul, 0, ',', '.')); ?></p>
                    </div>
                    <div class="text-right">
                        <p class="text-stone-400 text-[10px] uppercase tracking-wide">Target</p>
                        <p class="font-bold text-stone-500 text-sm">Rp <?php echo e(number_format($prog->target_dana, 0, ',', '.')); ?></p>
                    </div>
...
function slider() {
    return {
        current: 0,
        slides: <?php echo json_encode($kegiatanSlider->keys()->toArray(), 15, 512) ?>,
        labels: <?php echo json_encode($kegiatanSlider->pluck('judul')->toArray(), 15, 512) ?>,
        timer: null,
...
function kalender() {
    return {
        ...
        eventDates: <?php echo json_encode($kegiatan->pluck('tanggal')->map(fn($d) => \Carbon\Carbon::parse($d)->format('Y-m-d'))->toArray(), 15, 512) ?>,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\tpq-almukharijin\resources\views/beranda.blade.php ENDPATH**/ ?>