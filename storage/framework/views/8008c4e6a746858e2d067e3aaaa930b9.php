...
<?php $__env->startSection('title', 'Kegiatan – TPQ Al-Mukharijin'); ?>
        ...
        <div class="grid lg:grid-cols-3 gap-5 items-start">
            ...
            <div class="lg:col-span-1">
                <p class="text-[10px] font-bold text-stone-400 uppercase tracking-widest mb-3">
                    Semua Foto (<?php echo e(count($allPhotos)); ?>)
                </p>
...
<section class="py-20 bg-[#fafaf9]">
    <div class="max-w-6xl mx-auto px-6">
        ...
        <div class="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-12">
            ...
            <p class="text-stone-400 text-sm"><?php echo e($kegiatan->total()); ?> kegiatan terdokumentasi</p>
        </div>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <a href="<?php echo e(route('kegiatan.show', $item->id)); ?>"
                ...
                <div class="relative overflow-hidden" style="aspect-ratio:4/3;">
                    ...
                    <?php elseif($item->photos->first()): ?>
                        <img src="<?php echo e(Storage::url($item->photos->first()->foto)); ?>" alt="<?php echo e($item->judul); ?>"
                            class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105">
                    <?php else: ?>
                    ...
                    <div class="absolute bottom-3 right-3">
                        <span class="flex items-center gap-1 text-white text-[11px] font-semibold px-2.5 py-1 rounded-full"
                            ...
                            <?php echo e($item->photos->count()); ?> foto
                        </span>
                    </div>
                    <?php endif; ?>
                </div>
                ...
                <div class="p-5">
                    ...
                    <p class="text-stone-400 text-xs mt-2 line-clamp-2 leading-relaxed"><?php echo e($item->deskripsi); ?></p>
                    <?php endif; ?>
        ...
        <div class="mt-12 flex items-center justify-center gap-2">
            ...
            <?php else: ?>
            <a href="<?php echo e($kegiatan->previousPageUrl()); ?>"
            ...
            <?php $__currentLoopData = $kegiatan->getUrlRange(1, $kegiatan->lastPage()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if($page == $kegiatan->currentPage()): ?>
            ...
            <?php if($kegiatan->hasMorePages()): ?>
            <a href="<?php echo e($kegiatan->nextPageUrl()); ?>"
                class="w-10 h-10 rounded-xl flex items-center justify-center text-stone-600 border border-stone-200 hover:border-emerald-300 hover:text-emerald-700 transition-all">
...
function fotoSlider() {
    return {
        ...
        playing: true,
        timer: null,
        fotos: <?php echo json_encode($allPhotos, 15, 512) ?>,
        init() {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\tpq-almukharijin\resources\views/kegiatan/index.blade.php ENDPATH**/ ?>