...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Admin'); ?> — TPQ Al-Mukharijin</title>
...
<div x-data="{ mobileOpen: false }">
    ...
    <aside class="sidebar" :class="mobileOpen ? 'mobile-open' : ''">
        ...
        <nav class="sidebar-nav p-3">
            ...
            <a href="<?php echo e(route('admin.program.index')); ?>"
                class="nav-item <?php echo e(request()->routeIs('admin.program.*') ? 'active' : ''); ?>">
                <span class="nav-icon">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="<?php echo e(route('admin.profil.edit')); ?>"
                class="nav-item <?php echo e(request()->routeIs('admin.profil.*') ? 'active' : ''); ?>">
                <span class="nav-icon">
        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    Profil TPQ
            ...
            <a href="<?php echo e(route('admin.memoriam.index')); ?>"
                class="nav-item <?php echo e(request()->routeIs('admin.memoriam.*') ? 'active' : ''); ?>">
                <span class="nav-icon">
        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    In Memoriam
           ...
           <a href="<?php echo e(route('admin.pengasuh.index')); ?>"
                class="nav-item <?php echo e(request()->routeIs('admin.pengasuh.*') ? 'active' : ''); ?>">
                <span class="nav-icon">
        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    Pengasuh & Pengajar
            ...
            <a href="<?php echo e(route('admin.kegiatan.index')); ?>"
                class="nav-item <?php echo e(request()->routeIs('admin.kegiatan.*') ? 'active' : ''); ?>">
                <span class="nav-icon">
        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    Kegiatan
            ...
            <a href="<?php echo e(route('admin.kalender.index')); ?>"
                class="nav-item <?php echo e(request()->routeIs('admin.kalender.*') ? 'active' : ''); ?>">
                <span class="nav-icon">
        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/>
        </svg>
    ...
    Kalender Akademik
            ...
            <a href="<?php echo e(route('admin.pengumuman.index')); ?>"
                class="nav-item <?php echo e(request()->routeIs('admin.pengumuman.*') ? 'active' : ''); ?>">
                <span class="nav-icon">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="<?php echo e(route('admin.santri.index')); ?>"
                class="nav-item <?php echo e(request()->routeIs('admin.santri.*') ? 'active' : ''); ?>">
                <span class="nav-icon">
        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    Santri
            ...
            <a href="<?php echo e(route('admin.prestasi.index')); ?>"
                class="nav-item <?php echo e(request()->routeIs('admin.prestasi.*') ? 'active' : ''); ?>">
                <span class="nav-icon">
        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    Prestasi Santri
            ...
            <a href="<?php echo e(route('admin.admin.alumni.index')); ?>"
                class="nav-item <?php echo e(request()->routeIs('admin.admin.alumni.*') ? 'active' : ''); ?>">
                <span class="nav-icon">
        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    Alumni
            ...
            <a href="<?php echo e(route('admin.donasi.index')); ?>"
                class="nav-item <?php echo e(request()->routeIs('admin.donasi.*') ? 'active' : ''); ?>">
                <span class="nav-icon">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"/>
                    </svg>
            ...
            <a href="<?php echo e(route('admin.penggunaan.index')); ?>"
                class="nav-item <?php echo e(request()->routeIs('admin.penggunaan.*') ? 'active' : ''); ?>">
                <span class="nav-icon">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="flex items-center gap-3 px-3 py-2.5 rounded-xl bg-white/5">
                <div class="w-8 h-8 rounded-lg bg-amber-500/20 border border-amber-500/25 flex items-center justify-center flex-shrink-0">
                    <span class="text-amber-300 font-bold text-xs">
                        <?php echo e(strtoupper(substr(auth('admin')->user()->name ?? 'A', 0, 2))); ?>

                    </span>
                </div>
                <div class="flex-1 min-w-0">
                    <p class="text-white text-xs font-semibold truncate"><?php echo e(auth('admin')->user()->name ?? 'Admin'); ?></p>
    ...
    <div class="main-content">
        ...
        <header class="topbar">
            ...
            <div class="flex items-center gap-1.5 text-xs text-stone-400 flex-1 min-w-0">
                <a href="<?php echo e(route('admin.dashboard')); ?>" class="hover:text-emerald-600 transition-colors font-semibold text-stone-500 flex-shrink-0">
                    Admin
                </a>
                ...
                <div class="relative" x-data="{ open: false }">
                    ...
                    <div x-show="open" @click.outside="open = false" x-cloak
                        ...
                        <div class="px-4 py-3 bg-emerald-50 border-b border-stone-100">
                            <p class="text-xs font-bold text-emerald-800 truncate"><?php echo e(auth('admin')->user()->name ?? 'Admin'); ?></p>
                            <p class="text-[10px] text-emerald-600 truncate"><?php echo e(auth('admin')->user()->email ?? ''); ?></p>
                        </div>
                        <div class="p-1">
                            <form method="POST" action="<?php echo e(route('admin.logout')); ?>">
                                <?php echo csrf_field(); ?>
        ...
        <footer class="px-6 py-3 border-t border-stone-100">
            <p class="text-[11px] text-stone-300 text-center">© <?php echo e(date('Y')); ?> TPQ Al-Mukharijin — Panel Administrasi</p>
        </footer>
...
<?php /**PATH D:\laragon\www\tpq-almukharijin\resources\views/admin/layouts/app.blade.php ENDPATH**/ ?>