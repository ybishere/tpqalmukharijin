...
<a href="<?php echo e(route('admin.prestasi.index')); ?>"
    ...
    class="nav-item <?php echo e(request()->routeIs('admin.alumni.*') ? 'active' : ''); ?>">
    <span class="nav-icon">
        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
</html><?php /**PATH D:\laragon\www\tpq-almukharijin\resources\views/admin/layouts/app.blade.php ENDPATH**/ ?>