...
<?php $__env->startSection('title', 'Laporan Transparansi — TPQ Al-Mukharijin'); ?>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-10">
            ...
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 text-center">
                <div class="text-lg md:text-xl font-bold text-red-500">
                    Rp <?php echo e(number_format($totalPenggunaan, 0, ',', '.')); ?>

                </div>
                <div class="text-xs text-gray-500 mt-1">Total digunakan</div>
            </div>
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 text-center">
                <?php $saldo = $totalDonasi - $totalPenggunaan; ?>
            ...
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 text-center">
                <div class="text-lg md:text-xl font-bold text-amber-600"><?php echo e($totalDonatur); ?></div>
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden mb-8">
            <div class="px-5 py-4 border-b border-gray-100 flex items-center justify-between">
                ...
                <span class="text-xs bg-green-100 text-green-700 font-medium px-3 py-1 rounded-full">
                    <?php echo e($donasis->count()); ?> transaksi
                </span>
            </div>
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            <td class="px-5 py-3">
                                <div class="flex items-center gap-2">
                                    ...
                                    <span class="font-medium text-gray-700"><?php echo e($donasi->nama_donatur); ?></span>
                                </div>
                            </td>
                            <td class="px-5 py-3 text-gray-500"><?php echo e(Str::limit($donasi->program->nama_program, 30)); ?></td>
                            <td class="px-5 py-3">
                                <span class="px-2.5 py-1 rounded-full font-medium
                                    <?php echo e($donasi->metode == 'qris' ? 'bg-green-100 text-green-700' : 'bg-amber-100 text-amber-700'); ?>">
                            ...
                            <td class="px-5 py-3 text-gray-400">
                                <?php echo e($donasi->created_at->format('d M Y')); ?>
...
<div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
    <div class="px-5 py-4 border-b border-gray-100 flex items-center justify-between">
        ...
        <span class="text-xs bg-red-100 text-red-600 font-medium px-3 py-1 rounded-full">
            <?php echo e($penggunaans->count()); ?> catatan
        </span>
    </div>
    ...
    <div class="p-5">
        ...
        <div class="card p-0 overflow-hidden mb-4 last:mb-0 fade-up">
            <div class="grid md:grid-cols-3 gap-0">
                ...
                <?php if($penggunaan->bukti_foto): ?>
                <div class="md:col-span-1 bg-stone-100 relative">
                    <a href="<?php echo e(asset('storage/' . $penggunaan->bukti_foto)); ?>" target="_blank">
                        <img src="<?php echo e(asset('storage/' . $penggunaan->bukti_foto)); ?>"
                            alt="Bukti <?php echo e($penggunaan->uraian); ?>"
                ...
                <div class="md:col-span-2 p-6 flex flex-col justify-between">
                    <div>
                        ...
                        <span class="text-[10px] font-bold text-emerald-600 uppercase tracking-wider">
                            <?php echo e($penggunaan->program->nama_program ?? 'Umum'); ?>

                        </span>

                        
                        <h3 class="font-extrabold text-stone-900 text-base leading-snug mt-1 mb-3">
                            <?php echo e($penggunaan->uraian); ?>
                        ...
                        <div class="inline-flex items-center gap-2 bg-red-50 border border-red-100 rounded-xl px-4 py-2 mb-4">
                            ...
                            <span class="font-extrabold text-red-600 text-sm">
                                Rp <?php echo e(number_format($penggunaan->jumlah, 0, ',', '.')); ?>

                            </span>
                        </div>

                        
                        <?php if($penggunaan->keterangan ?? null): ?>
                        <p class="text-stone-500 text-xs leading-relaxed mb-3">
                            <?php echo e($penggunaan->keterangan); ?>
                    ...
                    <div class="flex items-center justify-between pt-3 border-t border-stone-100">
                        <div class="flex items-center gap-1.5 text-stone-400 text-xs">
                            ...
                            <?php echo e($penggunaan->created_at->translatedFormat('d F Y')); ?>

                        </div>

                        <?php if($penggunaan->bukti_foto): ?>
                        <a href="<?php echo e(asset('storage/' . $penggunaan->bukti_foto)); ?>"
                            target="_blank"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\tpq-almukharijin\resources\views/laporan/publik.blade.php ENDPATH**/ ?>