...
<div class="flex items-center justify-between mb-6">
    <div>
        ...
        <p class="text-xs text-stone-400 mt-0.5"><?php echo e($announcements->total()); ?> total pengumuman</p>
    </div>
            ...
            <tr class="hover:bg-stone-50/50 transition-colors">
                <td class="px-5 py-3.5">
                    <div class="flex items-center gap-3">
                        ...
                        <?php endif; ?>
                        <div class="min-w-0">
                            <p class="font-semibold text-stone-800 text-xs truncate max-w-[280px]"><?php echo e($item->judul); ?></p>
                            <p class="text-stone-400 text-[11px] mt-0.5"><?php echo e(Str::limit(strip_tags($item->isi), 60)); ?></p>
                        </div>
                    </div>
                </td>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\tpq-almukharijin\resources\views/admin/pengumuman/index.blade.php ENDPATH**/ ?>