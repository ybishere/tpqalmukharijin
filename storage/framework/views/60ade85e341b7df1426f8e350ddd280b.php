...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'TPQ Al-Mukharijin – Desa Kreman, Tegal'); ?></title>
    <meta name="description" content="<?php echo $__env->yieldContent('meta_description', 'TPQ Al-Mukharijin Desa Kreman, Kecamatan Warureja, Kabupaten Tegal — Mendidik generasi Qurani yang berakhlak mulia sejak 1991.'); ?>">
    <meta name="keywords" content="<?php echo $__env->yieldContent('meta_keywords', 'TPQ Al-Mukharijin, TPQ Desa Kreman, TPQ Warureja, TPQ Tegal, belajar Al-Quran Tegal, pendidikan Al-Quran'); ?>">
    ...
    <meta property="og:title" content="<?php echo $__env->yieldContent('og_title', 'TPQ Al-Mukharijin – Desa Kreman, Tegal'); ?>">
    <meta property="og:description" content="<?php echo $__env->yieldContent('og_description', 'TPQ Al-Mukharijin Desa Kreman — Mendidik generasi Qurani yang berakhlak mulia sejak 1991.'); ?>">
    <meta property="og:url" content="<?php echo e(url()->current()); ?>">
    <meta property="og:image" content="<?php echo $__env->yieldContent('og_image', asset('images/gedung-tpq.jpg')); ?>">
    ...
    <meta name="twitter:title" content="<?php echo $__env->yieldContent('og_title', 'TPQ Al-Mukharijin – Desa Kreman, Tegal'); ?>">
    <meta name="twitter:description" content="<?php echo $__env->yieldContent('og_description', 'TPQ Al-Mukharijin Desa Kreman — Mendidik generasi Qurani yang berakhlak mulia sejak 1991.'); ?>">
    <meta name="twitter:image" content="<?php echo $__env->yieldContent('og_image', asset('images/gedung-tpq.jpg')); ?>">
...
<header
    ...
    <div class="max-w-6xl mx-auto px-6 flex items-center justify-between">
        ...
        <a href="<?php echo e(route('beranda')); ?>" class="flex items-center gap-3 group">
            <div class="w-9 h-9 rounded-2xl overflow-hidden bg-white/15 border border-white/25 flex items-center justify-center group-hover:bg-white/25 transition-colors">
                <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Logo TPQ Al-Mukharijin" class="w-full h-full object-contain p-0.5">
            </div>
        ...
        <nav class="hidden lg:flex items-center gap-1">
            <a href="<?php echo e(route('beranda')); ?>"
                ...
                <?php echo e(request()->routeIs('beranda') ? 'text-amber-300 bg-white/10' : 'text-white/75 hover:text-white hover:bg-white/8'); ?>">
                Beranda
            </a>
            ...
            <div class="relative" x-data="{ open: false }"
                ...
                <button class="px-4 py-2 rounded-xl text-[13px] font-medium transition-all flex items-center gap-1.5
                    <?php echo e(request()->routeIs('profil.*') ? 'text-amber-300 bg-white/10' : 'text-white/75 hover:text-white hover:bg-white/8'); ?>">
                    Tentang
                ...
                <div x-show="open" x-transition:enter="transition ease-out duration-150"
                    ...
                    <div class="bg-white rounded-2xl shadow-xl border border-black/5 p-1.5 overflow-hidden">
                        <a href="<?php echo e(route('profil.index')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-[13px] text-stone-700 hover:bg-emerald-50 hover:text-emerald-800 transition-colors font-medium">
                        ...
                        <a href="<?php echo e(route('profil.memoriam')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-[13px] text-stone-700 hover:bg-emerald-50 hover:text-emerald-800 transition-colors font-medium">
                        ...
                        <a href="<?php echo e(route('profil.pengasuh')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-[13px] text-stone-700 hover:bg-emerald-50 hover:text-emerald-800 transition-colors font-medium">
            ...
            <a href="<?php echo e(route('kegiatan.index')); ?>"
                class="px-4 py-2 rounded-xl text-[13px] font-medium transition-all
                <?php echo e(request()->routeIs('kegiatan.*') ? 'text-amber-300 bg-white/10' : 'text-white/75 hover:text-white hover:bg-white/8'); ?>">
                Kegiatan
            </a>
            <a href="<?php echo e(route('pengumuman.index')); ?>"
                class="px-4 py-2 rounded-xl text-[13px] font-medium transition-all
                <?php echo e(request()->routeIs('pengumuman.*') ? 'text-amber-300 bg-white/10' : 'text-white/75 hover:text-white hover:bg-white/8'); ?>">
                Pengumuman
            </a>
            <a href="<?php echo e(route('alumni.index')); ?>"
                class="px-4 py-2 rounded-xl text-[13px] font-medium transition-all
                <?php echo e(request()->routeIs('alumni.*') ? 'text-amber-300 bg-white/10' : 'text-white/75 hover:text-white hover:bg-white/8'); ?>">
                Alumni
            </a>
    ...
    <div class="relative" x-data="{ open: false }"
        @mouseenter="open = true" @mouseleave="open = false">
        <button class="px-4 py-2 rounded-xl text-[13px] font-medium transition-all flex items-center gap-1.5
            <?php echo e(request()->routeIs('donasi.*') || request()->routeIs('infaq.*') ? 'text-amber-300 bg-white/10' : 'text-white/75 hover:text-white hover:bg-white/8'); ?>">
            Infaq & Donasi
            <svg class="w-3 h-3 transition-transform duration-200" :class="open ? 'rotate-180' : ''" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M19 9l-7 7-7-7"/>
            </svg>
    ...
    <div x-show="open"
        ...
        class="absolute top-full left-0 pt-2 w-52" style="display:none">
        <div class="bg-white rounded-2xl shadow-xl border border-black/5 p-1.5 overflow-hidden">
            <a href="<?php echo e(route('donasi.landing')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-[13px] text-stone-700 hover:bg-emerald-50 hover:text-emerald-800 transition-colors font-medium">
                <span class="w-7 h-7 rounded-lg bg-emerald-100 flex items-center justify-center shrink-0">
            ...
            <a href="<?php echo e(route('infaq.index')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-[13px] text-stone-700 hover:bg-amber-50 hover:text-amber-800 transition-colors font-medium">
                <span class="w-7 h-7 rounded-lg bg-amber-100 flex items-center justify-center shrink-0">
    ...
    <div x-show="open"
        ...
        style="display:none">
        <a href="<?php echo e(route('beranda')); ?>" @click="open=false" class="block px-4 py-3 rounded-xl text-sm text-white/80 hover:text-white hover:bg-white/8 transition-all font-medium">Beranda</a>
        <a href="<?php echo e(route('profil.index')); ?>" @click="open=false" class="block px-4 py-3 rounded-xl text-sm text-white/80 hover:text-white hover:bg-white/8 transition-all font-medium">Profil TPQ</a>
        <a href="<?php echo e(route('profil.memoriam')); ?>" @click="open=false" class="block px-4 py-3 rounded-xl text-sm text-white/80 hover:text-white hover:bg-white/8 transition-all font-medium">In Memoriam</a>
        <a href="<?php echo e(route('profil.pengasuh')); ?>" @click="open=false" class="block px-4 py-3 rounded-xl text-sm text-white/80 hover:text-white hover:bg-white/8 transition-all font-medium">Pengasuh & Pengajar</a>
        <a href="<?php echo e(route('kegiatan.index')); ?>" @click="open=false" class="block px-4 py-3 rounded-xl text-sm text-white/80 hover:text-white hover:bg-white/8 transition-all font-medium">Kegiatan</a>
        <a href="<?php echo e(route('pengumuman.index')); ?>" @click="open=false" class="block px-4 py-3 rounded-xl text-sm text-white/80 hover:text-white hover:bg-white/8 transition-all font-medium">Pengumuman</a>
        <a href="<?php echo e(route('alumni.index')); ?>" @click="open=false" class="block px-4 py-3 rounded-xl text-sm text-white/80 hover:text-white hover:bg-white/8 transition-all font-medium">Alumni</a>
        <div class="pt-1 border-t border-white/10">
            <a href="<?php echo e(route('donasi.landing')); ?>" @click="open=false" class="block px-4 py-3 rounded-xl text-sm text-white/80 hover:text-white hover:bg-white/8 transition-all font-medium">Donasi Program</a>
            <a href="<?php echo e(route('infaq.index')); ?>" @click="open=false" class="block px-4 py-3 rounded-xl text-sm text-white/80 hover:text-white hover:bg-white/8 transition-all font-medium">Infaq Kamisan</a>
        </div>
    </div>
</header>
...
<footer class="bg-[#0a1a12] text-white relative overflow-hidden">
    ...
    <div class="relative max-w-6xl mx-auto px-6 py-16">
        <div class="grid grid-cols-2 lg:grid-cols-12 gap-8 pb-12 border-b border-white/8">
            ...
            <div class="col-span-2 lg:col-span-4">
                ...
                <div class="flex gap-2 mt-6">
                    ...
                    <a href="https://facebook.com/<?php echo e($profil->facebook); ?>" target="_blank" aria-label="Facebook"
                    ...
                    <a href="https://instagram.com/<?php echo e($profil->instagram); ?>" target="_blank" aria-label="Instagram"
                        class="w-8 h-8 rounded-xl bg-white/8 hover:bg-white/16 border border-white/8 flex items-center justify-center transition-all hover:scale-110">
                        <svg class="w-3.5 h-3.5 text-white/60" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="https://youtube.com/<?php echo e($profil->youtube); ?>" target="_blank" aria-label="YouTube"
                        class="w-8 h-8 rounded-xl bg-white/8 hover:bg-white/16 border border-white/8 flex items-center justify-center transition-all hover:scale-110">
                        <svg class="w-3.5 h-3.5 text-white/60" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div class="lg:col-span-2">
                ...
                <ul class="space-y-3">
                    ...
                    <li><a href="<?php echo e(route($route)); ?>" class="text-white/35 text-sm hover:text-white/80 transition-colors"><?php echo e($label); ?></a></li>
            ...
            <div class="col-span-2 lg:col-span-4">
                ...
                <ul class="space-y-3">
                    <li class="flex items-start gap-2.5 text-white/35 text-sm">
                        ...
                        <?php echo e($profil?->alamat ?? 'Desa Kreman, Kec. Warureja, Kab. Tegal, Jawa Tengah'); ?>

                    </li>
                    <?php if($profil?->no_telp): ?>
                    <li>
                        <a href="https://wa.me/<?php echo e(preg_replace('/[^0-9]/', '', $profil->no_telp)); ?>"
                            target="_blank"
                    ...
                    <?php if($profil?->email): ?>
                    <li>
                        <a href="mailto:<?php echo e($profil->email); ?>"
                            class="flex items-center gap-2.5 text-white/35 hover:text-white/70 transition-colors text-sm">
        ...
        <div class="pt-6 flex flex-col md:flex-row items-center justify-between gap-3">
            <p class="text-white/20 text-xs">© <?php echo e(date('Y')); ?> TPQ Al-Mukharijin. Semua hak dilindungi.</p>
...
<?php if($profil?->no_telp): ?>
<a href="https://wa.me/<?php echo e(preg_replace('/[^0-9]/', '', $profil->no_telp)); ?>?text=Assalamualaikum, saya ingin bertanya tentang TPQ Al-Mukharijin"
    target="_blank"
...
</html><?php /**PATH D:\laragon\www\tpq-almukharijin\resources\views/layouts/app.blade.php ENDPATH**/ ?>