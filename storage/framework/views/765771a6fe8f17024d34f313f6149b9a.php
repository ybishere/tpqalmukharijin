    ...
    <div class="w-full max-w-md">
        ...
        <div class="card-login rounded-2xl overflow-hidden anim-2">
            ...
            <div class="p-8">
                ...
                <form method="POST" action="<?php echo e(route('admin.login.post')); ?>" class="space-y-5 anim-3">
                    <?php echo csrf_field(); ?>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="email" name="email" value="<?php echo e(old('email')); ?>"
                                ...
                                class="w-full border <?php echo e($errors->has('email') ? 'border-red-400 bg-red-50' : 'border-gray-300'); ?>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="password" name="password" id="passwordInput"
                                ...
                                class="w-full border <?php echo e($errors->has('password') ? 'border-red-400 bg-red-50' : 'border-gray-300'); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mt-6 pt-5 border-t border-gray-100 anim-4">
                    <p class="text-center text-xs text-gray-400">
                        TPQ Al-Mukharijin &copy; <?php echo e(date('Y')); ?> — Sistem Manajemen
                    </p>
                </div>
        ...
        <div class="text-center mt-4 anim-4">
            <a href="<?php echo e(route('beranda')); ?>" class="text-emerald-300 hover:text-white text-sm transition-colors inline-flex items-center gap-1.5">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php /**PATH D:\laragon\www\tpq-almukharijin\resources\views/admin/auth/login.blade.php ENDPATH**/ ?>