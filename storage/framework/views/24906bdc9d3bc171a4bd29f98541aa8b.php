...
<?php $__env->startSection('page_title', 'Manajemen Alumni'); ?>
...
<div class="flex items-center justify-between mb-6">
    <div>
        ...
        <div class="flex items-center gap-3 mt-1">
            <span class="text-[11px] font-semibold text-blue-600 bg-blue-50 px-2 py-0.5 rounded-full"><?php echo e($totalAlumni); ?> alumni</span>
            <span class="text-[11px] font-semibold text-stone-400 bg-stone-100 px-2 py-0.5 rounded-full"><?php echo e($totalAngkatan); ?> angkatan</span>
        </div>
    </div>
    <a href="<?php echo e(route('admin.admin.alumni.create')); ?>"
...
<div class="bg-white rounded-2xl border border-stone-100 shadow-sm overflow-hidden">
    <table class="w-full text-sm">
        ...
        <tbody class="divide-y divide-stone-50">
            <?php $__empty_1 = true; $__currentLoopData = $alumnis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <tr class="hover:bg-stone-50/50 transition-colors">
                ...
                <td class="py-3.5 text-xs text-stone-400"><?php echo e($item->keterangan ?? '-'); ?></td>
                <td class="px-5 py-3.5">
                    <div class="flex items-center justify-end gap-2">
                        <a href="<?php echo e(route('admin.admin.alumni.edit', $item)); ?>"
                        ...
                        <form method="POST" action="<?php echo e(route('admin.admin.alumni.destroy', $item)); ?>"
    ...
    <?php if($alumnis->hasPages()): ?>
    <div class="px-5 py-4 border-t border-stone-100"><?php echo e($alumnis->links()); ?></div>
    <?php endif; ?>
</div>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\tpq-almukharijin\resources\views/admin/alumni/index.blade.php ENDPATH**/ ?>