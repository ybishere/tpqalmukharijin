...
<?php $__env->startSection('title', 'Pengumuman – TPQ Al-Mukharijin'); ?>
    ...
    <div class="max-w-6xl mx-auto px-6">
        <div class="grid lg:grid-cols-3 gap-10">
            ...
            <div class="lg:col-span-2">
                ...
                <?php $featured = $pengumuman->first(); ?>
                <a href="<?php echo e(route('pengumuman.show', $featured->id)); ?>"
                    ...
                    <div class="relative overflow-hidden" style="aspect-ratio:16/7;">
                        ...
                        <div class="absolute bottom-0 left-0 right-0 p-6">
                            ...
                            <h2 class="text-white font-extrabold text-xl leading-tight"><?php echo e($featured->judul); ?></h2>
                            <p class="text-white/60 text-sm mt-1">
                                <?php echo e(\Carbon\Carbon::parse($featured->tanggal_publish)->translatedFormat('d F Y')); ?>
                    ...
                    <div class="p-7"
                        ...
                        <p class="text-stone-500 text-sm leading-relaxed line-clamp-2">
                            <?php echo e(Str::limit(strip_tags($featured->isi), 150)); ?>
                ...
                <div class="space-y-3">
                    <?php $__currentLoopData = $pengumuman->skip(1); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(route('pengumuman.show', $item->id)); ?>"
                        ...
                        <div class="shrink-0 w-11 h-11 rounded-xl flex items-center justify-center font-bold text-sm"
                            ...
                            <?php echo e(str_pad($i + 2, 2, '0', STR_PAD_LEFT)); ?>
                        ...
                        <div class="shrink-0 w-16 h-16 rounded-xl overflow-hidden">
                            <img src="<?php echo e(Storage::url($item->thumbnail)); ?>" alt="<?php echo e($item->judul); ?>"
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <p class="text-stone-400 text-xs mt-1 line-clamp-1">
                                <?php echo e(Str::limit(strip_tags($item->isi), 80)); ?>
                ...
                <div class="mt-10 flex items-center justify-center gap-2">
                    ...
                    <?php $__currentLoopData = $pengumuman->getUrlRange(1, $pengumuman->lastPage()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($page == $pengumuman->currentPage()): ?>
                    <span class="w-10 h-10 rounded-xl flex items-center justify-center text-sm font-bold text-white"
                        style="background:linear-gradient(135deg,#064e3b,#065f46);"><?php echo e($page); ?></span>
                    <?php else: ?>
            ...
            <div class="lg:col-span-1 space-y-6">
                    ...
                    <div class="p-4">
                        ...
                        <div class="mt-3 pt-3 border-t border-stone-100">
                            ...
                            <div style="background:#f0fdf4;border:1px solid #bbf7d0;border-radius:12px;padding:10px 12px;">
                                <p class="text-emerald-800 font-bold text-xs leading-tight"><?php echo e($agendaTerdekat->judul); ?></p>
                                <p class="text-emerald-600 text-[10px] mt-1">
                                    <?php echo e(\Carbon\Carbon::parse($agendaTerdekat->tanggal_publish)->translatedFormat('d F Y')); ?>
                ...
                <div class="bg-white rounded-2xl border border-stone-100 p-5 shadow-sm">
                    ...
                    <div class="space-y-3">
                        <?php $__currentLoopData = $agendaAkanDatang; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $agenda): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex gap-3 items-start">
                            <div class="shrink-0 text-center"
                                ...
                                <p class="text-amber-700 font-extrabold text-base leading-none">
                                    <?php echo e(\Carbon\Carbon::parse($agenda->tanggal)->format('d')); ?>

                                </p>
                                <p class="text-amber-600 text-[10px] font-semibold uppercase">
                                    <?php echo e(\Carbon\Carbon::parse($agenda->tanggal)->translatedFormat('M')); ?>

                                </p>
                            </div>
                            <div>
                                <p class="text-stone-800 font-semibold text-xs leading-snug"><?php echo e($agenda->judul); ?></p>
                                <p class="text-stone-400 text-[10px] mt-0.5">
                                    <?php echo e(\Carbon\Carbon::parse($agenda->tanggal)->translatedFormat('l')); ?>
...
function kalender() {
    return {
        ...
        viewDate: moment(),
        selected: moment(),
        eventDates: <?php echo json_encode($pengumumanDates, 15, 512) ?>,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\tpq-almukharijin\resources\views/pengumuman/index.blade.php ENDPATH**/ ?>