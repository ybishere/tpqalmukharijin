...
<header
    ...
    <div class="max-w-6xl mx-auto px-6 flex items-center justify-between">
        ...
        <nav class="hidden lg:flex items-center gap-1">
            ...
            <a href="{{ route('donasi.landing') }}"
                class="px-4 py-2 rounded-xl text-[13px] font-medium transition-all
                {{ request()->routeIs('donasi.*') ? 'text-amber-300 bg-white/10' : 'text-white/75 hover:text-white hover:bg-white/8' }}">
                Infaq
            </a>
        </nav>
    ...
    <div x-show="open"
        ...
        <div class="pt-1 border-t border-white/10">
            <a href="{{ route('donasi.landing') }}" @click="open=false" class="block px-4 py-3 rounded-xl text-sm text-amber-300 hover:text-amber-200 hover:bg-white/8 transition-all font-semibold">Infaq / Donasi</a>
        </div>
    </div>
</header>
{{-- ═══════════════ END NAVBAR ═══════════════ --}}
...
<footer class="bg-[#0a1a12] text-white relative overflow-hidden">
    ...
    <div class="relative max-w-6xl mx-auto px-6 py-16">
            ...
            <div class="col-span-2 lg:col-span-4">
                ...
                <ul class="space-y-3">
                    <li class="flex items-start gap-2.5 text-white/35 text-sm">
                        ...
                        {{ $profil?->alamat ?? 'Desa Kreman, Jawa Tengah' }}
                    </li>
                    @if($profil?->no_telp)
                    <li>
        ...
        <div class="pt-6 flex flex-col md:flex-row items-center justify-between gap-3">
            ...
            <p class="text-white/20 text-xs">Dibuat dengan ❤️ untuk para santri</p>
        </div>
    </div>
</footer>
{{-- ═══════════════ END FOOTER ═══════════════ --}}
