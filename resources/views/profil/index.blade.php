                ...
                <div class="mt-10 space-y-5">
                    ...
                    <div class="flex gap-4 fade-up">
                        <div class="shrink-0 w-14 text-right">
                            <span class="text-xs font-bold text-emerald-700">{{ $tahun }}</span>
                        </div>
                        <div class="relative pl-4 border-l-2 border-emerald-100 pb-5 last:pb-0">
                            ...
                            <p class="text-stone-600 text-sm leading-relaxed">{{ $keterangan }}</p>
                        </div>
                    </div>
                    @endforeach
                </div>
            ...
            <div class="fade-up relative overflow-hidden rounded-3xl p-8"
                ...
                <div class="relative z-10">
                    ...
                    <p class="text-white font-semibold text-lg leading-relaxed">
                        {{ $profil->visi ?? 'Menjadi lembaga pendidikan Al-Quran yang unggul, terpercaya, dan mampu mencetak generasi Qurani yang berakhlak mulia.' }}
                    </p>
                </div>
            </div>
            ...
            <div class="fade-up bg-stone-50 rounded-3xl p-8 border border-stone-100">
                ...
                <ul class="space-y-4">
                    ...
                    <li class="flex gap-3 items-start">
                        <span class="shrink-0 w-6 h-6 rounded-lg bg-emerald-100 flex items-center justify-center text-[11px] font-bold text-emerald-700 mt-0.5">{{ $i+1 }}</span>
                        <p class="text-stone-600 text-sm leading-relaxed">{{ $misi }}</p>
                    </li>
                    @endforeach
                </ul>
            </div>
    ...
    <div class="max-w-6xl mx-auto px-6">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            @php
                ...
                $c = $colors[$prog['color']];
            @endphp
            <div class="fade-up card p-6 {{ $c['border'] }}">
                <div class="w-12 h-12 rounded-2xl {{ $c['icon'] }} flex items-center justify-center mb-5">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="{{ $prog['icon'] }}"/>
                    </svg>
                </div>
                <h3 class="font-bold text-stone-900 mb-2">{{ $prog['judul'] }}</h3>
                <p class="text-stone-500 text-sm leading-relaxed">{{ $prog['desc'] }}</p>
            </div>
            @endforeach
        </div>
    </div>
            ...
            <div class="fade-up">
                ...
                <div class="space-y-5">
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <p class="text-[11px] font-bold text-stone-400 uppercase tracking-wide mb-0.5">{{ $info['label'] }}</p>
                            <p class="text-stone-700 text-sm font-medium">{{ $info['value'] }}</p>
                        </div>
                    </div>
                    @endforeach
                </div>
            ...
            <div class="fade-up">
                <div class="rounded-3xl overflow-hidden border border-stone-100 shadow-lg"
                    ...
                    <div class="absolute inset-0 flex flex-col items-center justify-center gap-3 text-stone-400">
                        ...
                        <a href="{{ $profil->maps_url ?? 'https://maps.google.com' }}" target="_blank"
