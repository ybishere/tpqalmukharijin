...
@section('breadcrumb')
    <a href="{{ route('admin.alumni.index') }}" class="hover:text-emerald-600 transition-colors">Alumni</a>
...
<div class="max-w-2xl">
    <form method="POST" action="{{ route('admin.alumni.update', $alumni) }}">
        ...
        <div class="flex items-center gap-3 mt-6">
            ...
            <a href="{{ route('admin.alumni.index') }}" class="text-sm text-stone-400 hover:text-stone-600 px-4 py-2.5">Batal</a>
        </div>
    </form>
</div>
@endsection