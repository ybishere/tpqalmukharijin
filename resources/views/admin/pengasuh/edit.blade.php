...
@section('title', 'Edit Pengasuh/Pengajar')
@section('page_title', 'Edit Pengasuh/Pengajar')
@section('breadcrumb')
...
@endsection
@section('content')
<form method="POST" action="{{ route('admin.pengasuh.update', $pengasuh) }}" enctype="multipart/form-data">
    @csrf @method('PUT')
