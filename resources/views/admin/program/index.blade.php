...
<div class="flex items-center justify-between mb-6">
    <div>
        ...
        <p class="text-sm text-gray-500">Total {{ $programs->total() }} program</p>
    </div>
                ...
                <tr class="hover:bg-gray-50 transition-colors">
                    <td class="px-5 py-4">
                        <div class="flex items-center gap-3">
                            @if ($program->foto)
                                <img src="{{ Storage::url($program->foto) }}" class="w-10 h-10 rounded-lg object-cover flex-shrink-0">
                            @else
                            ...
                            @endif
                            <div class="min-w-0">
                                <p class="font-semibold text-gray-800 truncate max-w-[200px]">{{ $program->nama_program }}</p>
                                <p class="text-xs text-gray-400 truncate max-w-[200px]">{{ Str::limit($program->deskripsi, 50) }}</p>
                            </div>
                        </div>
                    </td>
                    ...
                    <td class="px-5 py-4">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <span class="text-xs font-semibold text-gray-600">{{ $persen }}%</span>
                        </div>
                    </td>
                    <td class="px-5 py-4">
